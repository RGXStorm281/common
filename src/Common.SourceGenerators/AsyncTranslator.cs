...
public class AsyncTranslator
{
	...
	/// <param name="awaitableOverloads">A dictionary for resolving available async overload names for synchronous methods.</param>
	...
	)
	{
		...
		return IndentHelper.Indent("=> throw new System.NotImplementedException();");
	}
	...
	private string TryTranslateInvocationToAsync(InvocationExpressionSyntax invocation, TranslationContext context)
	{
		...
		// Potential receiver string like obj?. or StaticClass.
