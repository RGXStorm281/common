...
///<br/> <b>Source:</b>
///<br/> https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/template
/// </summary>
	...
	: HtmlTag
{
	...
	/// This allows a scoped CustomElementRegistry to be attached later using CustomElementRegistry.initialize().
	///<br/> <b>Source:</b>
	///<br/> https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/template
	/// </summary>
	public Template Shadowrootcustomelementregistry(string value)
	{
		return this.Attribute("shadowrootcustomelementregistry", value);
	}
