...
/// <summary>
/// Renders a search input for the <paramref name="node"/>.
/// </summary>
/// <param name="node">The node to render the search input for.</param>
public class SearchInput(ITextNode node) : IHtmlContent
{
