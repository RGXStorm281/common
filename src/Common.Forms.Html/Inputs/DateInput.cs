...
/// <summary>
/// Renders a date input for the <paramref name="node"/>.
/// </summary>
/// <param name="node">The node to render the date input for.</param>
public class DateInput(ITimestampNode node) : IHtmlContent
{
	...
	public void WriteTo(TextWriter writer, HtmlEncoder encoder)
	{
		...
		var content = Fieldset(
				...
				Input()
					...
					.Value(_node.Value?.ToString("yyyy-MM-dd") ?? string.Empty)
					.Id(nodeId),
