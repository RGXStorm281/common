...
/// <summary>
/// Renders a password input for the <paramref name="node"/>.
/// </summary>
/// <param name="node">The node to render the password input for.</param>
public class PasswordInput(ITextNode node) : IHtmlContent
{
