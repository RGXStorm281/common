...
/// <summary>
/// Renders a email input for the <paramref name="node"/>.
/// </summary>
/// <param name="node">The node to render the email input for.</param>
public class EmailInput(ITextNode node) : IHtmlContent
{
