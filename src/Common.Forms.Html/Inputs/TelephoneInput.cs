...
/// <summary>
/// Renders a telephone input for the <paramref name="node"/>.
/// </summary>
/// <param name="node">The node to render the telephone input for.</param>
public class TelephoneInput(ITextNode node) : IHtmlContent
{
