...
public class DepthFirstSearch(Func<IFormNode, bool> predicate, bool stopOnFirstMatch) : DepthFirstVisitor
{
	/// <summary>
	...
	public DepthFirstSearch(string name, bool stopOnFirstMatch)
