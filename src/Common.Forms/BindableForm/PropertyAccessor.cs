...
public class PropertyAccessor<TModel, TProperty>(Expression<Func<TModel, TProperty>> propertyExpression)
{
	...
	public TProperty Get(TModel model) => _getter(model);
	...
	public void Set(TModel model, TProperty value) => _setter(model, value);
}
