...
internal class IntField(
	...
	int? initialValue
) : FormFieldBase<IntField, int?>(id, parent, label, visibilityCondition, validators, initialValue)
{
	...
	public override IFieldDataContainer<int?> GetData() => new BasicFieldDataContainer<int?> { Value = Value };
}
